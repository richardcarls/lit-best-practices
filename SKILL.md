...
- `rules/2-7-ifdefined-conditional-attributes.md` - Use ifDefined for Conditional Attribute Removal
  (MEDIUM)
...
- `rules/3-7-cssresultgroup-subclass-styles.md` - Annotate Parent Styles as CSSResultGroup for
  Subclass Arrays (HIGH)
...
- `rules/8-2-implement-controller-interface.md` - Implement the ReactiveController Interface
  Correctly (HIGH)
...
- `rules/11-6-reflect-custom-accessors-host-intent.md` - Preserve Host Intent with Reflected Custom
  Accessors (HIGH)
...
- `10-1-configure-web-test-runner.md`; Web Test Runner/open-wc or Vitest browser mode with
  Playwright setup (CRITICAL)
